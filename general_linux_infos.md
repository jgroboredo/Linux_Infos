# 1. Table of contents
1. [Git notes](#1)
	1.1. [Notes on creating a git repository on github](#1.1)
	1.2. [Check previous commit](#1.2)
	1.3. [Git stash and log](#1.3)
	1.4. [Create local git repository](#1.4)
	1.5. [Change the author name](#1.5)
	1.6. [Remove tracked file that is now in .gitignore](#1.6)
	1.7. [Check last commit changes](#1.7)
	1.8. [Installing git in live ISO arch](#1.8)
	1.9. [Change remote URL](#1.9)
	1.10. [Add remote URL](#1.10)
	1.11. [Different Pushes](#1.11)
	1.12. [Use curl to download from github](#1.12)
	1.13. [Download a file from github](#1.13)
	1.14. [Merge branches](#1.14)
	1.15. [Check merge conflicts](#1.15)
	1.16. [Merge mistake](#1.16)
	1.17. [Git merge "Deleted by us"](#1.17)
	1.18. [Commit ID and SHA](#1.18)
	1.19. [Git over ssh using ssh config](#1.19)
...
# 2. Git notes <a name="1"></a>
## 2.1. Notes on creating a git repository on github <a name="1.1"></a>
...
### 2.1.1. Some notes on the above commands
...
## 2.2. Check previous commit <a name="1.2"></a>
```
	git log
...
## 2.5. Change the author name <a name="1.5"></a>
`git config --global user.name "John Doe"`

## 2.6. Remove tracked file that is now in .gitignore <a name="1.6"></a>
`git rm --cached <file>`

## 2.7. Check last commit changes <a name="1.7"></a>
...
## 2.11. Different Pushes <a name="1.11"></a>
...
## 2.17. Git merge "Deleted by us" <a name="1.17"></a>
